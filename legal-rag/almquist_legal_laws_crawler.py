...
class LegalLawsCrawler:
    ...
    def crawl_law(self, law_info):
        ...
        try:
            ...
            # Extract law text
            # Note: zakonyprolidi.cz structure might vary, adjust selectors as needed
            law_text = ""
            ...
            if content_div:
                ...
                paragraphs = content_div.find_all(['p', 'div', 'article'])
                law_text = '\n\n'.join([p.get_text(strip=True) for p in paragraphs if p.get_text(strip=True)])

                # If still empty, try to get all text
                if not law_text:
            ...
            law_data = {
                ...
                'full_text': law_text[:50000],  # Limit to 50k chars for now
